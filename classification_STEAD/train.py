...
def train_phasenet(data_dir : str = ".\\data\\STEAD", 
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers, drop_last=True, persistent_workers=True)
    val_loader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers, drop_last=True, persistent_workers=True)
    ...
    torch.save(model, "phasenet_15epochs.pt")
    

if __name__ == "__main__":
    train_phasenet(data_dir="../data", tri_width=10, cutting_length=136, batch_size=64, num_workers=10, epochs=15, lr=0.001)